...
require (
	...
	github.com/infopark/dxhub/go-tools/instance v0.0.0-20250717100957-bad68087b9de
...
require (
	github.com/JustRelate/go-kit/notify v1.0.0 // indirect
	github.com/JustRelate/go-kit/uuid v1.0.0 // indirect
