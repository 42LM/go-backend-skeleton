...
func request_Message_PutMsg_0(ctx context.Context, marshaler runtime.Marshaler, client MessageClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
...
func local_request_Message_PutMsg_0(ctx context.Context, marshaler runtime.Marshaler, server MessageServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var (
		protoReq PutMsgRequest
		metadata runtime.ServerMetadata
		err      error
...
func RegisterMessageHandlerServer(ctx context.Context, mux *runtime.ServeMux, server MessageServer) error {
	mux.Handle(http.MethodPost, pattern_Message_PutMsg_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/pb.Message/PutMsg", runtime.WithHTTPPathPattern("/v2/msg/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Message_PutMsg_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Message_PutMsg_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
// "MessageClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterMessageHandlerClient(ctx context.Context, mux *runtime.ServeMux, client MessageClient) error {
	mux.Handle(http.MethodPost, pattern_Message_PutMsg_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/pb.Message/PutMsg", runtime.WithHTTPPathPattern("/v2/msg/{id}"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Message_PutMsg_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	forward_Message_PutMsg_0 = runtime.ForwardResponseMessage
)
